...
const PAGE_URL = "https://www.infrabox.software/resources/tools/mailbox-calculator";
...
const RELATED_TOOLS = [
  {
    ...
    to: "deliverability-score",
    title: "Deliverability Score",
    desc: "Analyze domain health and DNS configuration.",
  },
  {
    href: "/resources/tools/spam-checker",
    to: "spam-checker",
    title: "Spam Checker",
    desc: "Test email content for spam triggers and filters.",
  },
  {
    href: "/resources/tools/email-header-analyzer",
    to: "email-header-analyzer",
    title: "Header Analyzer",
    desc: "Analyze email headers for authentication issues.",
  },
  {
    href: "/resources/tools/domain-scanner",
    to: "domain-scanner",
    title: "Domain Scanner",
    desc: "Comprehensive domain analysis for all email records.",
  },
  {
    href: "/resources/tools/blacklist-checker",
    to: "blacklist-checker",
    title: "Blacklist Checker",
    desc: "Check whether your domain or IP is on a blocklist.",
  },
  {
    href: "/learn/agency-workflows-guide",
    to: "agency-workflows",
    title: "Agency Workflows",
    desc: "Best practices for managing multiple campaigns.",
  },
];
  ...
  return (
    <>
      <JsonLd data={createWebPageSchema({
        name: "Email Mailbox Calculator | Infrabox",
        description: "Estimate how many mailboxes and domains you need for email, and what they cost. Size from a daily send volume, or work backwards from the meetings you want to book, across Google Workspace, Microsoft 365, and Azure.",
        url: PAGE_URL,
      })} />
      <JsonLd data={createBreadcrumbSchema([
        ...
        { name: "Mailbox Calculator", url: PAGE_URL },
      ])} />
      ...
      <JsonLd data={createHowToSchema({
        ...
        tool: "Infrabox Mailbox Calculator",
        totalTime: "PT2M",
        steps: HOW_TO_STEPS,
      })} />
      <JsonLd data={createWebApplicationSchema({
        name: "Email Mailbox Calculator",
        url: PAGE_URL,
        featureList: [
      ...
      <main id="main-content">
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-6xl w-full border-x border-gray-200 border-dashed px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 pt-8 text-sm text-gray-400">
              ...
              <span>/</span>
              <span className="text-gray-600">Mailbox Calculator</span>
            </div>
          </div>
        </section>

        {/* Hero */}
        <section className="bg-white border-gray-200 border-dashed">
          <div className="mx-auto max-w-6xl w-full border-x border-gray-200 border-dashed px-4 sm:px-6 lg:px-8 pt-10 pb-10">
        ...
        <section className="border-gray-200 border-dashed">
          <div className="mx-auto max-w-3xl w-full px-4 sm:px-6 lg:px-8 pb-16">
            <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-[#001050]">
        ...
        {/* Related tools (tools-hub framing) */}
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {RELATED_TOOLS.map((tool) => (
                  <Link
                    key={tool.href}
                    href={tool.href}
                    onClick={() => trackClick('tool_navigation', { from: 'mailbox-calculator', to: tool.to })}
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-6xl w-full border-x border-gray-200 border-dashed px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto mb-16 rounded-2xl border border-gray-200 bg-[#f9fafb] px-6 py-10 text-center">
              <p className="text-sm text-gray-500">Ready to compare plans?</p>
              <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  href="/pricing"
                  onClick={() => trackClick('tool_cta', { tool: 'mailbox-calculator', action: 'see_pricing' })}
                  className="rounded-full bg-[#1240cc] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#0b34b4] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1240cc]"
                >
                  See Infrabox pricing
                </Link>
                <Link
                  href="https://app.infrabox.software/signup"
                  onClick={() => trackClick('tool_cta', { tool: 'mailbox-calculator', action: 'signup' })}
                  className="rounded-full border border-[#1240cc] px-5 py-2.5 text-sm font-semibold text-[#1240cc] transition-colors hover:bg-[#1240cc] hover:text-white"
                >
                  Get started
                </Link>
              </div>
              <p className="mt-4 text-sm text-gray-500">
                Or learn more about{' '}
                <Link href="/learn/email-warmup-guide" className="font-medium text-[#1240cc] underline underline-offset-2 hover:text-[#0b34b4]">
                  warming up new mailboxes
                </Link>.
              </p>
            </div>
          </div>
