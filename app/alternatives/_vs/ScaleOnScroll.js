...
/**
 * Scroll-tied scale wrapper, shared by the *-vs-infrabox pages.
 *
 ...
 * full view. Re-entering from above re-applies the mapping.
 *
 * Props:
 *   - minScale: scale when the card's top is at the bottom of the viewport (default 0.85)
 *   - endRatio: fraction of viewport height at which the card reaches full scale (default 0.2)
